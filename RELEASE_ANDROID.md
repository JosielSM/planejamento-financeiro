...
O aplicativo usa `versionCode 6` e `versionName 1.5.0`. O APK disponível no site é compilado para testes diretos. Uma publicação pública deve usar uma chave privada definitiva e um Android App Bundle.
