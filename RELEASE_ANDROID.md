...
O aplicativo usa `versionCode 4` e `versionName 1.3.0`. O APK disponível no site é compilado para testes diretos. Uma publicação pública deve usar uma chave privada definitiva e um Android App Bundle.
